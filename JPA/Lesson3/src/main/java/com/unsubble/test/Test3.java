...
public class Test3 {
	public static void main(String[] args) {
		...
		Phone phone2 = new Phone("216", "HOME");
		...
		em.insertPhone(phone);
		em.insertPhone(phone2);
		
		em.insertProject(project);
		em.insertProject(project2);
		...
		Department found = entityManager.find(Department.class, 3);
